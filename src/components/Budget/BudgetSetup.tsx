          ...
          {categories.map((category) => (
            <div key={category.id} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
              <input
                ...
                className="w-12 text-center bg-white border border-gray-300 rounded px-2 py-1"
              />
              <input
                type="text"
                value={category.name}
              ...
              <input
                ...
                placeholder="0"
                className="w-32 bg-white border border-gray-300 rounded px-3 py-2 text-right"
              />
              <button
